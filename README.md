...
> **Based on [naver/pr-stats](https://github.com/naver/pr-stats)** (Apache 2.0 License)
...
| 이름             | 설명                                                                                    | 기본 값                                | 사용 예시                                                               |
|----------------|---------------------------------------------------------------------------------------|-------------------------------------|---------------------------------------------------------------------|
| `token`        | GitHub에서 제공하는 토큰입니다.                                                                  | `${{ secrets.GITHUB_TOKEN }}`       | `token: "ghp_xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"`  |
